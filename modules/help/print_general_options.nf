def print_help() {
    ...
    --sample_map [file]      Path to the sample map file (for example, see example/sample_pop.map), format: first column, sample id and the second column, population id. This is REQUIRED arguments only if the input is ".csv". Note that this file must end with the suffix ".map". 
