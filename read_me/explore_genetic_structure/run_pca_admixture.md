...
You will find the PCA results in two sub-folder **./genetic_structure/smartpca** and **./genetic_structure/gds_pca**.

Results of SmartPCA:
**\*_update_chrm_ids.ped** , **\*_update_chrm_ids.map**, 
**\*_update_chrm_ids.snp** , **\*_update_chrm_ids.ind**, **\*_update_chrm_ids.eigenstratgeno** : input files used for the analysis
...
You will find the admixture results in a sub-folder **./genetic_structure/admixture**:
...
**\*_update_chrm_ids.\${K}\.Q-${n}.png** : admixture plot of optimal K value
