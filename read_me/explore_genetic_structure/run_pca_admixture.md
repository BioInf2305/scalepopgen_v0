...
We moved forward to the tab named **genstruct_params** dedicated to the PCA, Admixture and both NJ clustering analyses (***/parameters/process/genstruct_params.config**), where we specify parameters described at the begining of this read.me. At the end, save the parameters as yml file. 
